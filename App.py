...
def MainMenu():    
    ...
    Boton_Creditos = tk.Button(ventana, text="Créditos", width=8, height=1,font=Fuente_principal,command=Ventana_creditos, bg = "#FFFFFF",  bd=1, disabledforeground=None,  relief="flat")
    Boton_Creditos.place(x=618, y=65)
    #Botón explicacion que hace que se cambie a la ventana de "How does it work?"
    Boton_Explicacion = tk.Button(ventana, text="¿Cómo funciona?", width=20, height=1,font=Fuente_principal,command=Ventana_Explicacion, bg = "#FFFFFF",  bd=1, disabledforeground=None,  relief="flat")
    ...
    def login():
        ...
        if(Validar_codigo == ""):
            Error = tk.Label(ventana, text = "Error, campos vacíos, intente de nuevo.",font=Fuente_principal, disabledforeground=None, bg = "#FFFFFF")
            Error.place(x = 600, y = 385) 
        else:  #si no esta vacío entonces se muestra la otra interfaz 
           if Validar_codigo in readfile: 
              Ventana_Opciones() 
           else: 
            Error = tk.Label(ventana, text = "Error, código no encontrado.",font=Fuente_principal, disabledforeground=None, bg = "#FFFFFF")
            Error.place(x = 600, y = 385)


    #boton para ingresar o acceder 
    Button_login = tk.Button(ventana, text="Acceder", width=7, height=1, command=login,font=Fuente_principal)
...
def Ventana_creditos():
    ...
    Boton_Regreso = tk.Button(ventana, text="", command= MainMenu, width=7, height=1, font=Fuente_principal, image = Imagen_Regresar_Creditos, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
...
def Ventana_Opciones():
    ...
    label1.pack()
    #Boton para regresarte al menú principal y para quitarle los bordes
    Boton_Regreso = tk.Button(ventana, text="", command= MainMenu, width=7, height=1,font=Fuente_principal, image = Imagen_Regresar, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_Regreso.place(x = 830, y =445, width=74, height=70)
    Boton_PisoB = tk.Button(ventana, text="Bloque B", command= Ventana_Pisos_BloqueB, width=7, height=1,font=Fuente_principal,image = Bloque_B, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_PisoB.place(x = 50, y =305, width=200, height=49)
    Boton_PisoC = tk.Button(ventana, text="Bloque C", width=7, height=1,font=Fuente_principal,image = Bloque_C, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_PisoC.place(x = 50, y =400, width=200, height=49)
    Boton_PisoD = tk.Button(ventana, text="Bloque D", width=7, height=1,font=Fuente_principal,image = Bloque_D, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_PisoD.place(x = 270, y =305, width=200, height=49)
    Boton_PisoK = tk.Button(ventana, text="Bloque K", width=7, height=1,font=Fuente_principal,image = Bloque_K, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_PisoK.place(x = 270, y =400, width=200, height=49)
    Boton_PisoG = tk.Button(ventana, text="Bloque G", width=7, height=1,font=Fuente_principal,image = Bloque_G, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_PisoG.place(x = 490, y =305, width=200, height=49)
    Boton_Biblioteca = tk.Button(ventana, text="Biblioteca", width=7, height=1,image = Biblioteca, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_Biblioteca.place(x = 490, y =400, width=200, height=49)
    Boton_CasaE = tk.Button(ventana, text="Casa Estudio", width=7, height=1,command = Ventana_Pisos_CasaE,image = Casa_Estudio, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
...
def Ventana_Pisos_BloqueB():
    ...
    label1.pack()
    #Boton para regresarte al menú principal y para quitarle los bordes
    Boton_Regreso = tk.Button(ventana, text="", command= Ventana_Opciones, width=7, height=1, font=Fuente_principal, image = Imagen_Regresar, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_Regreso.place(x = 830, y = 430, width=74, height=70)
    Boton_Piso1 = tk.Button(ventana, text="",  width=7, height=1, font=Fuente_principal, image = Piso1, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
    Boton_Piso1.place(x = 150, y = 355,width=200, height=49)
    Boton_Piso2 = tk.Button(ventana, text="",  width=7, height=1, font=Fuente_principal, image = Piso2, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
...
def Ventana_Pisos_CasaE():
    ...
    Boton_Piso3 = tk.Button(ventana, text="",  width=7, height=1, font=Fuente_principal, image = Piso3, bg = "#FFFFFF", bd=1, disabledforeground=None,  relief="flat")
